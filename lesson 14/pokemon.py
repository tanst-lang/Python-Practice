...
import random
# Wild Pokemon
# multidimensional list that holds pokemon names and their max health (you choose)
pokemons=[
    ['Greninja',10],
    ['pikachu',8],
    ['charmander',9],
...
# User Pokemon
# multidimensional list that holds pokemon attacks and their different damage
attacks=[
    ['fire blast',5],
    ['water blast',2],
    ['ground shock',3],
...
#user they defeated the pokemon
